...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "password change should reflect in login" do 
    newpass = "newpassword"
    post "/login", params: {name: @admin.username, password: @admin.password }
    patch "/change_password", params: {old_password: @admin.password, "user[password]": newpass, "user[password_confirmation]": newpass}
    get "/logout"
    post "/login", params: {name: @admin.username, password: @admin.password }
    get users_url
...
test "should not be able to change password with wrong old password" do
    newpass = "newpassword"
    post "/login", params: {name: @admin.username, password: @admin.password }
    patch "/change_password", params: {old_password: "wrong_password", "user[password]":newpass, "user[password_confirmation]":newpass}
