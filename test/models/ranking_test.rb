...
class ResultTest < ActiveSupport::TestCase
  ...
  test 'Create Statistic-Table for Year 2017' do
    ...
    assert(averages.versenkt_pro_spiel == 3 / 120.to_f,
           "Versenkt pro Spiel should be 0.025 but was #{averages[:versenkt_pro_spiel]}")
  ...
  def setup_jassers_rounds_and_results
    ...
    FactoryBot.create(:result, round_id: @t7.id, jasser_id: @j3.id, spiele: 10, differenz: 120, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)
    FactoryBot.create(:result, round_id: @t7.id, jasser_id: @j4.id, spiele: 10, differenz: 110, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)

    FactoryBot.create(:result, round_id: @t8.id, jasser_id: @j1.id, spiele: 10, differenz: 110, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)
    ...
    FactoryBot.create(:result, round_id: @t8.id, jasser_id: @j3.id, spiele: 10, differenz: 120, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)
    FactoryBot.create(:result, round_id: @t8.id, jasser_id: @j5.id, spiele: 10, differenz: 110, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)

    FactoryBot.create(:result, round_id: @t9.id, jasser_id: @j1.id, spiele: 10, differenz: 130, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)
    ...
    FactoryBot.create(:result, round_id: @t9.id, jasser_id: @j3.id, spiele: 10, differenz: 120, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)
    FactoryBot.create(:result, round_id: @t9.id, jasser_id: @j7.id, spiele: 10, differenz: 110, max: 20, roesi: 0, droesi: 0,
                               versenkt: 0, gematcht: 0, huebimatch: 0, chimiris: 0)
  end
end
