class ApplicationHelperTest < ActionView::TestCase
  test "should return encrypted" do
    ...
    jasser2 = FactoryBot.create(:jasser, name:"jasser2", email:"mail_mit123_schnickschnack@TESs.co.uk", disqualifiziert:false)
    jasserinaktiv = FactoryBot.create(:jasser, name:"jasser3", email:"hallo@gmail.com", active:false, disqualifiziert:false)
    ...
    assert_dom_equal("<a href='' data-js-decrypt-mailto-links='#{expected_string}' class='decent'>Mail an alle Jasser</a>", encrypted_mailto_link_for_adresses(@all_active_jassers_email))
