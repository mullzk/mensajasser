class AggregatedAngstgegnerResultsOfJasser
  ...
  attr_reader :spiele, :eigene_differenz, :gegner_differenz, :max, :versenkt, :roesi, :droesi, :gematcht, :huebimatch, :chimiris
  ...
  def gegner_schnitt
    self.gegner_differenz/@spiele.to_f
  end
  
  def schaedling_index
    self.eigener_schnitt/self.gegner_schnitt
  end
