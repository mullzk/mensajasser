Rails.application.routes.draw do
  ...
  get 'ranking/schlimmstespiele' => 'ranking#schlimmstespiele'

  match 'login' => 'users#login', via: %i[get post], as: :login
  match 'logout' => 'users#logout', via: :get, as: :logout
  match 'change_password' => 'users#change_own_password', via: %i[get patch], as: :change_password
end
